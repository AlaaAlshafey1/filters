...
@section('page-header')
    <div class="page-header py-3 px-3 mt-3 mb-3 bg-white shadow-sm rounded-3 border d-flex justify-content-between align-items-center flex-wrap gap-3"
        ...
        <div class="d-flex flex-column">
            <h4 class="content-title mb-1 fw-bold text-primary">إدارة ميزات السلايدر</h4>
            <small class="text-muted">عرض جميع الميزات والتحكم بها</small>
        </div>

        <div class="d-flex flex-wrap justify-content-start gap-2">
            @can('features_create')
                <a href="{{ route('features.create') }}" class="btn btn-primary btn-sm d-flex align-items-center gap-1"
...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <small class="text-muted">عرض جميع الميزات المسجلة</small>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="featuresTable" class="table table-hover table-striped text-center align-middle">
