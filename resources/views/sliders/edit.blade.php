...
<div class="page-header py-3 px-3 mt-3 mb-3 bg-white shadow-sm rounded-3 border d-flex justify-content-between align-items-center flex-wrap gap-3" style="direction: rtl;">
    ...
    <div>
        <a href="{{ route('sliders.index') }}" class="btn btn-secondary btn-sm d-flex align-items-center gap-1">
...
<div class="slider-form-card">
    <form method="POST" action="{{ route('sliders.update',$slider->id) }}" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="title_ar" class="form-control"
                           value="{{ old('title_ar',$slider->title_ar) }}" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="description_ar" class="form-control"
                              rows="3">{{ old('description_ar',$slider->description_ar) }}</textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label">الوصف (إنجليزي)</label>
                    <textarea name="description_en" class="form-control"
                              rows="3">{{ old('description_en',$slider->description_en) }}</textarea>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    @if($slider->image)
                        <div class="mt-2">
                            ...
                            <img src="{{ asset('storage/'.$slider->image) }}" class="slider-preview">
                        </div>
                    @endif
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="is_active" class="form-select">
                        <option value="1" {{ $slider->is_active ? 'selected' : '' }}>مفعّل</option>
                        <option value="0" {{ !$slider->is_active ? 'selected' : '' }}>غير مفعّل</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end gap-2 mt-4">
            ...
            <a href="{{ route('sliders.index') }}" class="btn btn-light border">
