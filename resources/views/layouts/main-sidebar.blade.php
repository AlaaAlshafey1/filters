...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="#"><img src="{{URL::asset('assets/img/logo.jpg')}}"
    ...
    <div class="main-sidemenu">
                ...
                <div class="">
                    <a href="{{ route('dashboard') }}">
                        <img alt="user-img" class="avatar avatar-xl brround"
                            src="{{URL::asset('assets/img/logo.jpg')}}">
                    </a>
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                @can('sectors_view')
                    <a class="side-menu__item" href="{{ route('sectors.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path d="M5 4h14v4H5zm0 6h14v4H5zm0 6h14v4H5z" />
                        </svg>
                        <span class="side-menu__label">قطاعات</span>
                    </a>
                @endcan
            </li>
