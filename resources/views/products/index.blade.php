...
<div class="page-header py-3 px-3 mt-3 mb-3 bg-white shadow-sm rounded-3 border d-flex justify-content-between align-items-center flex-wrap gap-3" style="direction: rtl;">
    <div class="d-flex flex-column">
        <h4 class="content-title mb-1 fw-bold text-primary">إدارة المنتجات</h4>
        <small class="text-muted">عرض جميع المنتجات والتحكم بها</small>
    </div>
    <div class="d-flex flex-wrap justify-content-start gap-2">
        <a href="{{ route('products.create') }}" class="btn btn-primary btn-sm d-flex align-items-center gap-1" style="background-color:#c1953e; border-color:#c1953e;">
            <i class="bx bx-plus-circle fs-5"></i> <span>إضافة منتج جديد</span>
        </a>
    </div>
</div>
@endsection
...
<div class="card">
    <div class="card-header">
        ...
        <small class="text-muted">عرض جميع المنتجات المسجلة</small>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="productsTable" class="table table-hover table-striped text-center align-middle">
                        ...
                        <tr>
                            ...
                            <td class="text-start">
                                <div class="d-flex align-items-center gap-2">
                                    <div>
                                        <div><strong>{{ $product->name_ar }}</strong></div>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('products.destroy', $product->id) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من الحذف؟')">
                                        @csrf
                                        @method('DELETE')
