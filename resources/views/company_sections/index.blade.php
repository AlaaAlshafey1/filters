...
@section('page-header')
    <div class="page-header py-3 px-3 mt-3 mb-3 bg-white shadow-sm rounded-3 border d-flex justify-content-between align-items-center flex-wrap gap-3"
        ...
        <div class="d-flex flex-wrap justify-content-start gap-2">
            <a href="{{ route('company-sections.create') }}" class="btn btn-primary btn-sm d-flex align-items-center gap-1"
                    ...
                    <tbody>
                        @foreach($sections as $key => $section)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('company-sections.edit', $section->id) }}"
                                            class="btn btn-outline-warning btn-sm">
                                            <i class="bx bx-edit-alt"></i>
                                        </a>

                                        <form action="{{ route('company-sections.destroy', $section->id) }}" method="POST"
